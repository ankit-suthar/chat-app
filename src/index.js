...
// socket.emit -> send message to current client who are on same connection
// io.emit -> send message to all clients who are on same connection
// socket.broadcast.emit -> send message to the all clients except current one

// io.on -> to start connection when client joins
// socket.on -> to connect from server to same client
